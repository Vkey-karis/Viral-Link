        ...
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="flex flex-col items-center text-center space-y-12">
            ...
            <div className="w-full max-w-4xl relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 rounded-[3rem] blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
              <div className="relative bg-slate-950/80 backdrop-blur-3xl border border-white/10 p-4 rounded-[3.5rem] flex flex-col md:flex-row items-center gap-4 shadow-[0_50px_100px_rgba(0,0,0,0.6)]">
                <div className="flex-1 flex items-center px-8 gap-6 w-full group/input">
                  <Search className="w-7 h-7 text-indigo-500 group-hover/input:scale-110 transition-transform" />
                  <input 
                    type="text" 
                    placeholder="Paste your Amazon, Jumia, or Selar link here..." 
                    className="w-full bg-transparent border-none focus:ring-0 text-white font-bold py-6 text-xl placeholder-slate-700 cursor-pointer"
                    readOnly
                    onClick={onStart}
                  />
                </div>
                <button 
                  onClick={onStart}
                  className="w-full md:w-auto px-12 py-6 bg-indigo-600 text-white font-black uppercase tracking-[0.2em] rounded-[2.5rem] hover:bg-indigo-500 hover:scale-[1.03] transition-all flex items-center justify-center gap-4 shadow-2xl shadow-indigo-600/40"
                >
                  Post & Profit <ArrowRight className="w-6 h-6" />
                </button>
              </div>
